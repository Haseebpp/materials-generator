...
import { loadMaterials } from "@/lib/materialsService"
...
export function MaterialList({ onAdd, isPriceVisible }: MaterialListProps) {
    ...
    const groupedMaterials = useMemo(() => {
        ...
        const filtered = materials.filter(m =>
            ...
            Object.values(m.details).some(val =>
    ...
    const defaultValue = useMemo(() => {
        ...
        return Object.keys(groupedMaterials).slice(0, 10)
                            ...
                            >
                                {Object.entries(groupedMaterials).map(([category, items]) => (
                                    <AccordionItem
                                        key={category}
                                        value={category}
                                        className="border-b-0 mb-2 bg-card"
                                    >
